...
{
    /// <summary>
    /// Clase utilizada para manejar la comunicación de mensajes a través de sockets entre el servidor y los clientes.
    /// </summary>
    /// <typeparam name="T">Tipo de mensaje que se enviará a través del socket.</typeparam>
